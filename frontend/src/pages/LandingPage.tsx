    ...
    <div className="min-h-screen flex flex-col items-center justify-center relative overflow-hidden bg-[#050505]">
      ...
      >
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
          ...
          <button className="px-10 py-4 bg-zinc-950 text-zinc-500 font-bold text-xs uppercase tracking-widest border border-zinc-800 hover:bg-zinc-900 transition-all">
            System Protocol
          </button>
        </div>
